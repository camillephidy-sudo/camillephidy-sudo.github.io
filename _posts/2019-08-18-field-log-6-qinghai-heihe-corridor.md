...
As part of the **Heihe River Basin Ecohydrological Observation Network Upgrade** and the NSFC Key Project on *authenticity verification of terrestrial remote sensing products* (No. 41531174), our Beijing Normal University team conducted a **Qinghai Lake → Heihe wetland corridor transect** in August 2019. This reconnaissance supported downstream ET and soil-moisture product validation across elevation and land-cover gradients.

## Objectives

1. Characterize soil moisture and vegetation gradients along the corridor
2. Excavate reference soil profiles for sensor calibration and gravimetric checks
3. Identify candidate nodes for the upgraded **24-station** Heihe ecohydrological network
4. Document ground conditions for coupling with upcoming microwave/radiometer campaigns
...
The transect established reproducible soil-profile protocols reused at **Daman** and **Huazhaizi** superstations during the September intensive observation phase, directly supporting soil-moisture product disaggregation from 25 km → 1 km scales.
