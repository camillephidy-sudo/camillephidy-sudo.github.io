...
**Daman Superstation** is the flagship node of the Heihe Watershed Allied Telemetry Experimental Research (HiWATER) network and a core validation site for the **ecohydrological observation network upgrade**. In mid-September 2019, our team supported instrument checks linking **ground-based microwave radiometry**, meteorological sensing, and eddy-covariance flux measurements to satellite ET/SM product verification.

## Objectives

1. Verify RPG microwave radiometer alignment and data continuity
2. Inspect tower-mounted radiation shields and optical sensors
3. Coordinate ground truth for **Penman–Monteith / RS-PM** ET product intercomparison
4. Support NSFC Key Project reporting on remote sensing product authenticity (Nov 2019 milestone)
...
Daman data underpinned September 2019 progress reports on:

- **Random Forest downscaling** of SMAP soil moisture (0.25° → 0.01°)
- **Triple collocation** and ground-station RMSE benchmarks across the upper Heihe River Basin (uHRB)
- **ET algorithm intercomparison** (RS-PM, Penman–Monteith, machine-learning hybrids)
